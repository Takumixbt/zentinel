  ...
  return (
    <div className="panel p-4 sm:p-5">
      <div className="mb-4 flex items-center justify-between">
        <div>
          <h2 className="font-display text-lg font-semibold text-content">The confidential vault</h2>
      ...
      {submittedDone && !posRevealed && (
        <div className="mt-3 flex items-center justify-between gap-3 border border-hairline bg-surface-inset/50 px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-content-muted">
            <KeyRound className="h-4 w-4 text-brand" />
            These figures are encrypted on-chain. Decrypt them privately with your key.
          </div>
          <Button variant="outline" size="sm" onClick={revealMyPosition} loading={phase === "decrypting"}>
